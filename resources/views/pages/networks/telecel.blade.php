...
<section class="network-hero-section telecel-hero">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 fade-up">
        <div class="network-logo-badge mb-4">
          <img src="assets/networks/TLC.jpg" alt="Telecel" class="network-logo-large">
        </div>
        <h1 class="network-hero-title mb-3">Telecel Data Bundles</h1>
        <p class="network-hero-text mb-4">Get the best deals on Telecel data bundles. Fast delivery, affordable prices, and reliable service. Stay connected with quality network coverage across Ghana.</p>
...
<section class="bundles-section py-5">
  <div class="container">
    <div class="text-center mb-5 fade-up">
      ...
      <h2 class="section-title fw-bold mb-3">Telecel Data Plans</h2>
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6 col-lg-4 fade-up" style="animation-delay: 0.1s;">
            <div class="bundle-card">
              ...
              <div class="bundle-price">
                <span class="price-amount">GH₵ 4.80</span>
                <span class="price-original">GH₵ 6.80</span>
              </div>
          ...
          <div class="col-md-6 col-lg-4 fade-up" style="animation-delay: 0.2s;">
            <div class="bundle-card">
              ...
              <div class="bundle-price">
                <span class="price-amount">GH₵ 8.80</span>
                <span class="price-original">GH₵ 11.50</span>
              </div>
              <ul class="bundle-features">
                <li><i class="bi bi-check-circle-fill text-success"></i> All Networks</li>
                <li><i class="bi bi-check-circle-fill text-success"></i> Instant Activation</li>
          ...
          <div class="col-md-6 col-lg-4 fade-up" style="animation-delay: 0.3s;">
            <div class="bundle-card">
              ...
              <div class="bundle-price">
                <span class="price-amount">GH₵ 19.00</span>
                <span class="price-original">GH₵ 26.00</span>
              </div>
              <ul class="bundle-features">
                <li><i class="bi bi-check-circle-fill text-success"></i> All Networks</li>
                <li><i class="bi bi-check-circle-fill text-success"></i> Instant Activation</li>
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6 col-lg-4 fade-up">
            <div class="bundle-card">
              ...
              <div class="bundle-price">
                <span class="price-amount">GH₵ 33.00</span>
                <span class="price-original">GH₵ 47.00</span>
              </div>
              <ul class="bundle-features">
                <li><i class="bi bi-check-circle-fill text-success"></i> All Networks</li>
                <li><i class="bi bi-check-circle-fill text-success"></i> Instant Activation</li>
          ...
          <div class="col-md-6 col-lg-4 fade-up" style="animation-delay: 0.1s;">
            <div class="bundle-card">
              ...
              <div class="bundle-price">
                <span class="price-amount">GH₵ 57.00</span>
                <span class="price-original">GH₵ 80.00</span>
              </div>
              <ul class="bundle-features">
                <li><i class="bi bi-check-circle-fill text-success"></i> All Networks</li>
                <li><i class="bi bi-check-circle-fill text-success"></i> Instant Activation</li>
          ...
          <div class="col-md-6 col-lg-4 fade-up" style="animation-delay: 0.2s;">
            <div class="bundle-card">
              ...
              <div class="bundle-price">
                <span class="price-amount">GH₵ 115.00</span>
                <span class="price-original">GH₵ 160.00</span>
              </div>
              <ul class="bundle-features">
                <li><i class="bi bi-check-circle-fill text-success"></i> All Networks</li>
                <li><i class="bi bi-check-circle-fill text-success"></i> Instant Activation</li>
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6 col-lg-4 fade-up">
            <div class="bundle-card">
              ...
              <div class="bundle-price">
                <span class="price-amount">GH₵ 145.00</span>
                <span class="price-original">GH₵ 210.00</span>
              </div>
              <ul class="bundle-features">
                <li><i class="bi bi-check-circle-fill text-success"></i> All Networks</li>
                <li><i class="bi bi-check-circle-fill text-success"></i> Instant Activation</li>
          ...
          <div class="col-md-6 col-lg-4 fade-up" style="animation-delay: 0.1s;">
            <div class="bundle-card">
              ...
              <div class="bundle-price">
                <span class="price-amount">GH₵ 240.00</span>
                <span class="price-original">GH₵ 360.00</span>
              </div>
              <ul class="bundle-features">
                <li><i class="bi bi-check-circle-fill text-success"></i> All Networks</li>
                <li><i class="bi bi-check-circle-fill text-success"></i> Instant Activation</li>
          ...
          <div class="col-md-6 col-lg-4 fade-up" style="animation-delay: 0.2s;">
            <div class="bundle-card">
              ...
              <div class="bundle-price">
                <span class="price-amount">GH₵ 435.00</span>
                <span class="price-original">GH₵ 620.00</span>
              </div>
              <ul class="bundle-features">
                <li><i class="bi bi-check-circle-fill text-success"></i> All Networks</li>
                <li><i class="bi bi-check-circle-fill text-success"></i> Instant Activation</li>
...
<section class="why-network-section py-5 bg-light">
  <div class="container">
    <div class="text-center mb-5 fade-up">
      <h2 class="section-title fw-bold mb-3">Why Choose Telecel?</h2>
      <p class="section-subtitle text-muted">Reliable connectivity with excellent customer service</p>
    </div>
